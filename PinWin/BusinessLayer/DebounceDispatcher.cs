...
// Thanks to Rick Strahl, code taken from here:
...
namespace PinWin.BusinessLayer
{
    ...
    public class DebounceDispatcher
    {
            ...
            Dispatcher disp = null)
        {
            ...
            this.timer = new DispatcherTimer(TimeSpan.FromMilliseconds(interval), priority, (s, e) =>
            {
                if (this.timer == null)
                {
                    return;
            ...
            Dispatcher disp = null)
        {
            ...
            if (curTime.Subtract(this.timerStarted).TotalMilliseconds < interval)
            {
                interval -= (int)curTime.Subtract(this.timerStarted).TotalMilliseconds;
            }
